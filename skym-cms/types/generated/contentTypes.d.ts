...
export interface ApiAboutUsAboutUs extends Struct.SingleTypeSchema {
  ...
  attributes: {
    about_us_image: Schema.Attribute.Media<'images'>;
    ...
    > &
      Schema.Attribute.Private;
    our_story: Schema.Attribute.RichText &
      Schema.Attribute.SetMinMaxLength<{
        minLength: 512;
      }>;
    publishedAt: Schema.Attribute.DateTime;
    ...
    yoga_categories: Schema.Attribute.Component<
      'yoga-styles.yoga-categories',
      true
    >;
  };
}
...
export interface ApiContactUsInquiryContactUsInquiry
  extends Struct.CollectionTypeSchema {
...
declare module '@strapi/strapi' {
  export module Public {
    export interface ContentTypeSchemas {
      ...
      'api::contact-us-inquiry.contact-us-inquiry': ApiContactUsInquiryContactUsInquiry;
